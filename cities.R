...
tatorter <-
  sf::st_read("data-raw/cities/Tatorter_1980_2020.gpkg", layer = "To2020_SR99TM") |>
...
for (f in list.files("data-raw/cities/", full.names = T)) {
